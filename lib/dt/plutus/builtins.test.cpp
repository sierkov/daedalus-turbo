    ...
    "plutus::builtins"_test = [] {
        "v1"_test = [] {
            ...
            "less_than_equals_byte_string"_test = [&] {
                expect(less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("") }, { alloc, uint8_vector::from_hex("") }).as_bool());
                expect(less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("") }, { alloc, uint8_vector::from_hex("AA") }).as_bool());
                expect(!less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("AA") }, { alloc, uint8_vector::from_hex("") }).as_bool());
                expect(less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("AA") }, { alloc, uint8_vector::from_hex("AA") }).as_bool());
                expect(less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("AABB") }, { alloc, uint8_vector::from_hex("BBAA") }).as_bool());
                expect(!less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("BBAA") }, { alloc, uint8_vector::from_hex("AABB") }).as_bool());
                expect(less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("AABB") }, { alloc, uint8_vector::from_hex("AABBCC") }).as_bool());
            };
            "append_byte_string"_test = [&] {
                expect(append_byte_string(alloc, { alloc, uint8_vector::from_hex("") },
                        { alloc, uint8_vector::from_hex("AA") }).as_bstr() == uint8_vector::from_hex("AA"));
                expect(append_byte_string(alloc, { alloc, uint8_vector::from_hex("AA") },
                        { alloc, uint8_vector::from_hex("") }).as_bstr() == uint8_vector::from_hex("AA"));
                expect(append_byte_string(alloc, { alloc, uint8_vector::from_hex("11") },
                        { alloc, uint8_vector::from_hex("2233") }).as_bstr() == uint8_vector::from_hex("112233"));
            };
            "cons_byte_string"_test = [&] {
                expect(cons_byte_string(alloc, { alloc, 0x41 },
                        { alloc, uint8_vector::from_hex("42") }).as_bstr() == uint8_vector::from_hex("4142"));
                expect(cons_byte_string(alloc, { alloc, 0x42 },
                        { alloc, uint8_vector::from_hex("") }).as_bstr() == uint8_vector::from_hex("42"));
                expect(throws([&] { cons_byte_string(alloc, { alloc, -1 }, { alloc, uint8_vector::from_hex("") }); }));
            };
            "slice_byte_string"_test = [&] {
                expect(slice_byte_string(alloc, { alloc, -10 }, { alloc, 2 },
                    { alloc, uint8_vector::from_hex("0011223344") }).as_bstr() == uint8_vector::from_hex("0011"));
                expect(slice_byte_string(alloc, { alloc, 2 }, { alloc, -1 },
                    { alloc, uint8_vector::from_hex("0011223344") }).as_bstr() == uint8_vector::from_hex(""));
                expect(slice_byte_string(alloc, { alloc, 2 }, { alloc, 10 },
                    { alloc, uint8_vector::from_hex("0011223344") }).as_bstr() == uint8_vector::from_hex("223344"));
                expect(slice_byte_string(alloc, { alloc, 20 }, { alloc, 10 },
                   { alloc, uint8_vector::from_hex("0011223344") }).as_bstr() == uint8_vector::from_hex(""));
            };
            "length_of_byte_string"_test = [&] {
                expect(length_of_byte_string(alloc, { alloc, uint8_vector::from_hex("") }).as_int() == 0);
                expect(length_of_byte_string(alloc, { alloc, uint8_vector::from_hex("0011223344") }).as_int() == 5);
            };
            "index_byte_string"_test = [&] {
                expect(index_byte_string(alloc, { alloc, uint8_vector::from_hex("0011223344") }, { alloc, 0 }).as_int() == 0x00);
                expect(index_byte_string(alloc, { alloc, uint8_vector::from_hex("0011223344") }, { alloc, 2 }).as_int() == 0x22);
                expect(index_byte_string(alloc, { alloc, uint8_vector::from_hex("0011223344") }, { alloc, 4 }).as_int() == 0x44);
                expect(throws([&] { index_byte_string(alloc, { alloc, uint8_vector::from_hex("0011223344") }, { alloc, -1 }); }));
                expect(throws([&] { index_byte_string(alloc, { alloc, uint8_vector::from_hex("0011223344") }, { alloc, 5 }); }));
                expect(throws([&] { index_byte_string(alloc, { alloc, uint8_vector::from_hex("0011223344") }, { alloc, cpp_int { std::numeric_limits<size_t>::max() } + 1 }); }));
            };
            "equals_byte_string"_test = [&] {
                expect(equals_byte_string(alloc, { alloc, uint8_vector::from_hex("") }, { alloc, uint8_vector::from_hex("") }).as_bool());
                expect(!equals_byte_string(alloc, { alloc, uint8_vector::from_hex("") }, { alloc, uint8_vector::from_hex("AA") }).as_bool());
                expect(!equals_byte_string(alloc, { alloc, uint8_vector::from_hex("BB") }, { alloc, uint8_vector::from_hex("") }).as_bool());
                expect(equals_byte_string(alloc, { alloc, uint8_vector::from_hex("AABB") }, { alloc, uint8_vector::from_hex("AABB") }).as_bool());
                expect(!equals_byte_string(alloc, { alloc, uint8_vector::from_hex("AABB") }, { alloc, uint8_vector::from_hex("AABBCC") }).as_bool());
            };
            "less_than_byte_string"_test = [&] {
                expect(less_than_byte_string(alloc, { alloc, uint8_vector::from_hex("") }, { alloc, uint8_vector::from_hex("AA") }).as_bool());
                expect(!less_than_byte_string(alloc, { alloc, uint8_vector::from_hex("") }, { alloc, uint8_vector::from_hex("") }).as_bool());
                expect(!less_than_byte_string(alloc, { alloc, uint8_vector::from_hex("AA") }, { alloc, uint8_vector::from_hex("AA") }).as_bool());
                expect(less_than_byte_string(alloc, { alloc, uint8_vector::from_hex("AA") }, { alloc, uint8_vector::from_hex("AABB") }).as_bool());
            };
            "less_than_equals_byte_string"_test = [&] {
                expect(less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("") }, { alloc, uint8_vector::from_hex("AA") }).as_bool());
                expect(!less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("AA") }, { alloc, uint8_vector::from_hex("") }).as_bool());
                expect(less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("") }, { alloc, uint8_vector::from_hex("") }).as_bool());
                expect(less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("AA") }, { alloc, uint8_vector::from_hex("AA") }).as_bool());
                expect(less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("AA") }, { alloc, uint8_vector::from_hex("AABB") }).as_bool());
                expect(!less_than_equals_byte_string(alloc, { alloc, uint8_vector::from_hex("AABB") }, { alloc, uint8_vector::from_hex("AA") }).as_bool());
            };
            "sha2_256"_test = [&] {
                {
                    const value exp { alloc, sha2::hash_256::from_hex("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855") };
                    const auto act = sha2_256(alloc, { alloc, uint8_vector::from_hex("") });
                ...
                }
                {
                    ...
                    const auto act = sha2_256(alloc, { alloc, uint8_vector::from_hex("de188941a3375d3a8a061e67576e926dc71a7fa3f0cceb97452b4d3227965f9ea8cc75076d9fb9c5417aa5cb30fc22198b34982dbb629e") });
                    expect(exp == act) <<fmt::format("{}", act);
                }
            };
            "sha3_256"_test = [&] {
                {
                    ...
                    const auto act = sha3_256(alloc, { alloc, uint8_vector::from_hex("") });
                    expect(exp == act) <<fmt::format("{}", act);
                }
                {
                    const value exp { alloc, sha3::hash_256::from_hex("33BE80DD552BB39D0AC8212313AE729C26EDE50613491E5ABFB57686ECF037F5") };
                    const auto act = sha3_256(alloc, { alloc, uint8_vector::from_hex("de188941a3375d3a8a061e67576e926dc71a7fa3f0cceb97452b4d3227965f9ea8cc75076d9fb9c5417aa5cb30fc22198b34982dbb629e") });
                    expect(exp == act) <<fmt::format("{}", act);
                }
            };
            "blake2b_256"_test = [&] {
                {
                    ...
                    const auto act = blake2b_256(alloc, { alloc, uint8_vector::from_hex("") });
                    expect(exp == act) <<fmt::format("{}", act);
                }
                {
                    const value exp { alloc, blake2b_256_hash::from_hex("E1EAE5A8ADAE652EC9AF9677346A9D60ECED61E3A0A69BFACF518DB31F86E36B") };
                    const auto act = blake2b_256(alloc, { alloc, uint8_vector::from_hex("00010203") });
                    expect(exp == act) <<fmt::format("{}", act);
                }
            };
            ...
            "decode_utf8"_test = [&] {
                const value b { alloc, uint8_vector { "Some UTF8 string: ÖÜ ЯЯ"sv } };
            ...
            "fst_pair"_test = [&] {
                expect(fst_pair(alloc, { alloc, constant { alloc, constant_pair { alloc, plutus::constant { alloc, 22 }, plutus::constant { alloc, 33 } } } }).as_int() == 22);
                expect(fst_pair(alloc, { alloc, constant { alloc, constant_pair { alloc, plutus::constant { alloc, 33 }, plutus::constant { alloc, 0 } } } }).as_int() == 33);
            };
            "snd_pair"_test = [&] {
                expect(snd_pair(alloc, { alloc, constant { alloc, constant_pair(alloc, plutus::constant(alloc, 22), plutus::constant(alloc, 33)) } }).as_int() == 33);
                expect(snd_pair(alloc, { alloc, constant { alloc, constant_pair { alloc, plutus::constant(alloc, 33), plutus::constant(alloc, 0) } } }).as_int() == 0);
            };
            "choose_list"_test = [&] {
                {
                    expect(choose_list(alloc, value::make_list(alloc, constant_type { alloc, type_tag::integer }), { alloc, 11 }, { alloc, 22 }).as_int() == 11);
                }
                {
                    constant_list cl { alloc, constant_type { alloc, type_tag::integer }, constant_list::list_type { { constant { alloc, cpp_int(0) } }, alloc.resource() } };
                    expect(choose_list(alloc, { alloc, std::move(cl) }, { alloc, 11 }, { alloc, 22 }).as_int() == 22);
                }
            };
            "mk_cons"_test = [&] {
                {
                ...
                {
                    constant_list cl { alloc, constant_type { alloc, type_tag::integer }, { { constant { alloc, cpp_int(0) } }, alloc.resource() } };
            ...
            "head_list"_test = [&] {
                ...
                }
                {
                    ...
                    vals.emplace_back(alloc, cpp_int(22));
                ...
                }
                {
                    constant_list::list_type vals { alloc.resource() };
                    vals.emplace_back(alloc, cpp_int(22));
                    vals.emplace_back(alloc, cpp_int(33));
                    vals.emplace_back(alloc, cpp_int(44));
                    constant_list cl{ alloc, constant_type { alloc, type_tag::integer }, std::move(vals) };
                    expect(head_list(alloc, value { alloc, constant { alloc, std::move(cl) } }).as_int() == 22);
                }
                expect(throws([&] { head_list(alloc, value::make_list(alloc, constant_type { alloc, type_tag::integer })); }));
            ...
            "tail_list"_test = [&] {
                ...
                {
                    constant_list cl { alloc, constant_type { alloc, type_tag::integer }, { { constant { alloc, cpp_int(22) } }, alloc.resource() } };
            ...
            "choose_data"_test = [&] {
                ...
                const auto bstr = b_data(alloc, { alloc, uint8_vector::from_hex("112233") });
            ...
            "constr_data/un_constr_data"_test = [&] {
                {
                    ...
                    const auto val = value::make_list(alloc, constant_type { alloc, type_tag::data },
                        constant_list::list_type { { constant { alloc, data::bint(-5) } }, alloc.resource() });
                ...
                }
                {
                    ...
                    const auto val = value::make_list(alloc, constant_type { alloc, type_tag::data },
                        constant_list::list_type { { constant { alloc, data::bint(1) }, constant { alloc, data::bint(15) } }, alloc.resource() });
                    const auto res = constr_data(alloc, id, val);
                ...
                }
                {
                    ...
                    const auto val = value::make_list(alloc, constant_type { alloc, type_tag::data },
                        constant_list::list_type { { constant { alloc, data::bstr({ uint8_vector::from_hex("AABBCC") }) }, constant { alloc, data::bstr({ uint8_vector::from_hex("CCBBAA") }) } }, alloc.resource() });
                    const auto res = constr_data(alloc, id, val);
                    const auto act = un_constr_data(alloc, res);
                    const auto &act_vals = act.as_pair();
                    expect(act_vals.first == id.as_const());
            ...
            "map_data/un_map_data"_test = [&] {
                ...
                {
                    const auto val = value::make_list(alloc, constant_list::list_type { {
                        constant {alloc,
                            constant_pair(alloc,
                               i_data(alloc, { alloc, -5 }).as_const(),
                               b_data(alloc, { alloc, uint8_vector::from_hex("112233") }).as_const()
                           )
                        },
                        constant { alloc, constant_pair(alloc,
                            i_data(alloc, { alloc, 17 }).as_const(),
                            b_data(alloc, { alloc, uint8_vector::from_hex("AABBCC") }).as_const()
                        ) }
                    }, alloc.resource() });
                    const auto res = map_data(alloc, val);
                    const auto act = un_map_data(alloc, res);
                ...
                expect(throws([&] { map_data(alloc, value::make_list(alloc, { plutus::constant(alloc, 22) })); }));
            };
            "list_data/un_list_data"_test = [&] {
                ...
                }
                {
                    const auto val = value::make_list(alloc, {
                        plutus::constant { i_data(alloc, { alloc, -5 }).as_const() },
                        plutus::constant { i_data(alloc, { alloc, 88 }).as_const() }
                    });
                    const auto res = list_data(alloc, val);
                    const auto act = un_list_data(alloc, res);
                    expect(val == act) << fmt::format("exp: {} act: {}", val, act);
                ...
                {
                    const auto val = value::make_list(alloc, {
                        plutus::constant { b_data(alloc, { alloc, uint8_vector::from_hex("112233") }).as_const() },
                        plutus::constant { b_data(alloc, { alloc, uint8_vector::from_hex("556677") }).as_const() }
                    });
                    const auto res = list_data(alloc, val);
                    const auto act = un_list_data(alloc, res);
                    expect(val == act) << fmt::format("exp: {} act: {}", val, act);
            ...
            "equals_data"_test = [&] {
                expect(equals_data(alloc, { alloc, data::bint(123) }, { alloc, data::bint(123) }).as_bool());
                expect(!equals_data(alloc, { alloc, data::bint(123) }, { alloc, data::bstr(uint8_vector::from_hex("1234")) }).as_bool());;
            };
            "mk_pair_data"_test = [&] {
                const cpp_int a { 1 };
                const cpp_int b { 2 };
