...
#ifndef DAEDALUS_TURBO_CLI_SYNC_TURBO_HPP
#define DAEDALUS_TURBO_CLI_SYNC_TURBO_HPP
    ...
    struct cmd: command {
        const command_info &info() const override
        {
            static const command_info i {
                "sync-turbo", "<data-dir> [--host=<host>] [--max-epoch=<epoch>]",
...
#endif // !DAEDALUS_TURBO_CLI_SYNC_TURBO_HPP