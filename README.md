...
# About
Daedalus Turbo is an open-source project that aims to drastically (>=10x) improve the blockchain synchronization performance of the Daedalus wallet, the primary fully-decentralized wallet of the Cardano blockchain. The project has a two-year schedule presented in its [roadmap](#roadmap),
...
- Withdrawals of staking rewards; inflows are ignored.
...
precisely matched the stake recorded in the ledger snapshot produced by Cardano Node. The testing was performed with slot number 77374448 at the tip of the blockchain. The code of the test is located in the [test](test/) directory of this repository.
...
The [experiment](./experiment/) directory contains the source code of benchmarks and experiments discussed in the project's research reports.
